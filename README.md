...
|------|---------|------|---------|
| vscode | 1.122.0 | 2026-05-28 | [1.122.0](https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-x64) |
...
[versions.json updated @ 2026-05-28 13:42:52.752136](versions.json)
