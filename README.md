...
|------|---------|------|---------|
| vscode | 1.101.0 | 2025-06-12 | [May 2025](https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-x64) |
| dbeaver | 25.1.0 | 2025-06-01 | [25.1.0](https://dbeaver.io/files/dbeaver-ce_latest_amd64.deb) |
| golang | 1.24.4 | 2025-06-16 | [1.24.4](https://golang.org/dl/go1.24.4.linux-amd64.tar.gz) |

[versions.json updated @ 2025-06-16 13:05:32.385311](versions.json)
