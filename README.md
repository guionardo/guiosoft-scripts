...
|------|---------|------|---------|
| vscode | 1.110 | 2026-03-04 | [February 2026](https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-x64) |
| dbeaver | 26.0.0 | 2026-03-01 | [26.0.0](https://dbeaver.io/files/dbeaver-ce_latest_amd64.deb) |
| golang | 1.26.1 | 2026-03-06 | [1.26.1](https://golang.org/dl/go1.26.1.linux-amd64.tar.gz) |

[versions.json updated @ 2026-03-06 00:55:10.865070](versions.json)
